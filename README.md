...
Ce modèle s'appelle ici *enreg* et il précise le nom et le type de chacun des champ contenu dans la structure (*numero*, *quantite* et *prix*).
...
Une variable comme *article_1* va réservé un emplacement de type *enreg* destiné à contenir deux int (*numero* et *quantite*) et un flottant (*prix*).
